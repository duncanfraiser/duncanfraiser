...
@section('content')
    ...
    <div class="col-md-12" style="background-color: #000">
        <div class="skills">
          ...
          <div class="col-md-3 col-sm-6 os-animation skill" data-os-animation="fadeInLeft" data-os-animation-delay="0.1s">
            <h2>Server</h2>
            <p>{!!$landing->serv!!}</p>
          </div>

          <div class="col-md-3 col-sm-6 os-animation skill" data-os-animation="fadeInDown" data-os-animation-delay="0.3s">
            <h2>Database</h2>
            <p>{!!$landing->db!!}</p>
          </div>

          <div class="col-md-3 col-sm-6 os-animation skill" data-os-animation="fadeInUp" data-os-animation-delay="0.5s">
            <h2>Backend</h2>
            <p>{!!$landing->backend!!}</p>
          </div>

           <div class="col-md-3 col-sm-6 os-animation skill" data-os-animation="fadeInRight" data-os-animation-delay="0.7s">
            <h2>Frontend</h2>
    ...
    <div class="col-md-12 work">
      ...
      <div class="col-md-3 col-sm-6 flex-center os-animation" data-os-animation="fadeIn" data-os-animation-delay={{$delays[$key]}}>
